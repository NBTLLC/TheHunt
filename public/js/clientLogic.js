...
$(document).ready(function () {
	...
	$(".edit").on("click", handleCompanyEdit); // needs to be on click of company box
	//------------------
...
// //OPENING DELETE MODAL
	$(".clear").on("click", handleCompanyClose); // needs to be on click of company box
